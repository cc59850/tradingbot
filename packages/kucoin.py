...
def make_currency_pair_string(currency_pair):
    ...
    return  str(currency_pair.base).upper()+'-'+str(currency_pair.reference).upper()
...
class Kucoin(EXCHANGE.Exchange):
    ...
    def __init__(self,account, base_url=None):
        ...
        if not base_url is None:
            ...
            self.base_url=EXCHANGE.Exchange.MARKET_BASEURL_MAPPING['Kucoin']
