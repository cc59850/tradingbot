...
def make_currency_pair_string(currency_pair):
    ...
    return Bitstamp.COINNAMEMAPPING.get(str(currency_pair.base),str(currency_pair.base))+Bitstamp.COINNAMEMAPPING.get(str(currency_pair.reference),str(currency_pair.reference))
...
class Bitstamp(EXCHANGE.Exchange):
    ...
    def __init__(self,account, base_url=None):
        ...
        if not base_url is None:
            ...
            self.base_url=EXCHANGE.Exchange.MARKET_BASEURL_MAPPING['Bitstamp']
    ...
    def depth(self,currency_pair, limit=20, raw=False, type='step2'):
        # v3: https://www.bitstamp.net/api/v2/order_book/btcusd/
        '''
        ...
        DEPTH_RESOURCE = "/api/v2/order_book/"
